package org.flow.utils.common.enums;
...
public enum ErrorCode {
     ...
     * 422 Unprocesable pojo - [POST/PUT/PATCH] 当创建一个对象时，发生一个验证错误。
     * 500 INTERNAL SERVER ERROR - [*]：服务器发生错误，用户将无法判断发出的请求是否成功。
     */
    OK("200", "OK - [GET]：服务器成功返回用户请求的数据，该操作是幂等的（Idempotent）"),
    CREATED("201", "CREATED - [POST/PUT/PATCH]：用户新建或修改数据成功"),
