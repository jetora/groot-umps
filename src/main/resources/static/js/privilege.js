...
$(function () {
    ...
    $('#search_privilegename').bind('keyup', function (event) {
        if (event.keyCode == "13") {
            //回车执行查询
            searchData();
        }
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#account_table').bootstrapTable({
            url: '/api/privilege/pageInfo',                      //请求后台的URL（*）
            method: 'GET',                      //请求方式（*）
            dataType: "json",
...
function optFormatter(value, row) {
    ...
    ret_butns.push('<a class="graph" href="javascript:void(0)" title="grant"><i class="fa fa-cc"></i></a> ');
...
function addData() {
    ...
    accountModal.find('.modal-body #privilegename').val("");
    accountModal.find('.modal-body #description').val("");
...
function editData(row) {
    ...
    accountModal.find('.modal-body #privilegename').val(row.name);
    accountModal.find('.modal-body #description').val(row.description);
...
function get_form_data() {
    ...
    data.privilegename = accountModal.find('.modal-body #privilegename').val();
    data.description = accountModal.find('.modal-body #description').val();
