...
$(function () {
    ...
    $('#search_resource_name').val("")
    $('#search_resource_name').bind('keyup', function (event) {
        if (event.keyCode == "13") {
            //回车执行查询
            searchData();
        }
...
var queryParams = function (params) {
    var temp = {
        ...
        resource_name: $("#search_resource_name").val(),
        resource_type: $("#search_resource_type").val(),
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#resource_table').bootstrapTable({
            url: '/api/resource/pageInfo',                      //请求后台的URL（*）
            method: 'GET',                      //请求方式（*）
            dataType: "json",
